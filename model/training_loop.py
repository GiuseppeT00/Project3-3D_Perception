...
from model_segformer.model_retriever import MMSegmentor


def exec_training_loop(train_loader: DataLoader, model: MMSegmentor, criterion: nn.Module,
                       optimizer: AdamW, device: str, epoch: int, epochs: int,
                       num_classes: int, ignore_label: int) -> dict:
